...
<?php if(isset($message_email->message_email_1)): ?>
  <title><?php echo e($message_email->message_email_1); ?> Sisas</title>
<?php endif; ?>
</head>
	...
	<tr>
		<td class="container" width="480px" style="margin: auto">
			<div class="content">
              ...
              <img style="min-width: 150px; width: 15%;max-width: 250px; max-height:250px; display: block; margin-top:30px; margin-bottom:30px;" src="<?php echo e(env("IMAGE_URL").$event->style['email_img_logo']); ?>"/>
              ...
              <div>
                      ...
                      <tr>
                          <td>
                            <?php if($tracking!=false): ?>
                              <!--<img style="width: 100%;            max-width: 100%;"  src="<?php echo e(env("IMAGE_URL").$event->style['email_img_banner']); ?>/<?php echo e($tracking); ?>"/>-->
                ...
                <tr>
                  <td class="aligncenter content-block">
                    <center>
                      <a href="<?php echo e($outlook_365); ?>" class="btn-primary width-80" style="width: 90%; background: #2172b9; border:solid 2px#fff; padding:10px 20px ;color:#fff; text-decoration:none">
                        <b>Office 365</b>
                      ...
                      <a href="<?php echo e($link_google); ?>" class="btn-primary width-80" style="width: 90%; background: #e94235; border: solid 2px#fff;  padding:10px 20px; color:#fff; text-decoration:none">
                        <b>Google</b>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 50 50" width="15px" height="15px">
                      ...
                      <a href="<?php echo e($outlook); ?>" class="btn-primary width-80" style="width: 90%; background: #2172b9; border:solid 2px#fff; padding:10px 20px ;color:#fff; text-decoration:none">
                        <b>Outlook.com</b>
                      ...
                      <a href="<?php echo e($ics); ?>" class="btn-primary width-80" style="width: 90%; background: #ccc0c0; border:solid 2px#fff; padding:10px 20px; color:#fff; text-decoration:none">
                        <b>Apple</b>
...
<?php /**PATH /home/forge/backend-eventmovile.aicode-test.art/resources/views/events/confirmation.blade.php ENDPATH**/ ?>